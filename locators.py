urls = {'main_page': 'https://stellarburgers.nomoreparties.site',  # ссылка на главную страницу
        ...
        'password_recovery_page': 'https://stellarburgers.nomoreparties.site/forgot-password'}  # ссылка на страницу восстановления пароля

reg_name_field = './/fieldset/div/div/input'  # поле "имя" на странице регистрации
...
log_in_login_button = './/button[text() = "Войти"]'  # кнопка "войти" на странице входа
...
log_out_button = './/button[text() = "Выход"]'  # кнопка перехода из личного кабинета в конструктор
